<!--user widgets-->
 <div class="row">
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder" style="background-color:#470D9D">
                            <div class="panel-body">
                                <i class="fa fa-users fa-5x"></i>
                                <h3><?php countrecords("customers"); ?></h3>
                            </div>
                            <div class="panel-footer " style="background-color:#09192A">
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder" style="background-color:#7126EE">
                            <div class="panel-body">
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder" style="background-color:#907ffc">
                            <div class="panel-body">
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder" style="background-color:#9DAAEE">
                            <div class="panel-body">
